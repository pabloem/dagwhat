...
class ExecutionUtilsTest(unittest.TestCase):
    ...
    @parameterized.expand([
        ([TaskOutcome.SUCCESS, TaskOutcome.SUCCESS], [TaskOutcome.FAILURE, TaskOutcome.FAILURE]),
        ([TaskOutcome.FAILURE, TaskOutcome.FAILURE], [TaskOutcome.FAILURE, TaskOutcome.SUCCESS]),
        ([TaskOutcome.FAILURE, TaskOutcome.SUCCESS], [TaskOutcome.SUCCESS, TaskOutcome.FAILURE]),
        ([TaskOutcome.SUCCESS, TaskOutcome.FAILURE], [TaskOutcome.SUCCESS, TaskOutcome.SUCCESS]),
        (
